...
export const metadata: Metadata = {
  title: 'Наш мед',
  description:
    'Натуральний мед від сімейної пасіки на Харківщині — Акація, Липа, Сонях, Різнотрав\'я, Сади, Ліс. Упаковка 1L пластик або скло. Замовляйте напряму від пасічника.',
  openGraph: {
    title: 'Наш мед | Дача TV',
    description: 'Сезонний мед без домішок від пасіки на Харківщині',
  },
}
