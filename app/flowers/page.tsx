...
export const metadata: Metadata = {
  ...
  description:
    'Хризантеми та квіти від домашнього розсадника. Помпонові, кущові та великоквіткові сорти. Перевірені на Харківщині.',
  openGraph: {
    title: 'Квіти | Дача TV',
    description: 'Хризантеми від домашнього розсадника на Харківщині.',
  },
}
