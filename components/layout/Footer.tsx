    ...
    <footer className="bg-white border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          {/* Honey varieties column */}
          <div>
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">
              Сорти меду
            </h3>
            <nav className="flex flex-col gap-2.5" aria-label="Сорти меду">
              {['акація', 'липа', 'сонях', 'різнотрав\'я', 'сади', 'ліс'].map((variety) => (
                <Link
                  key={variety}
                  href="/honey"
                  className="text-sm text-gray-600 hover:text-bark transition-colors capitalize"
                >
